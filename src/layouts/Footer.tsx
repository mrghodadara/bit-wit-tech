        ...
        <div className="bg-footer-1 bg-fixed py-12 lg:py-28">
          <Container>
            <div className="flex flex-col items-center gap-4 lg:gap-6 py-4">
              ...
              <h3 className="font-montserrat text-4xl lg:text-[75px] font-black leading-10 text-white">
                {`Let's get to work`}
              </h3>
              <Link
                href={'#'}
                className="mt-6 lg:mt-12 rounded-md border-2 border-white bg-transparent px-10 py-3.5 font-poppins text-base font-medium uppercase text-white shadow-2xl duration-300 ease-linear hover:-translate-y-1.5 hover:bg-white hover:text-light-purple-75"
              >
                CONTACT US
              </Link>
            </div>
      ...
      <div className="bg-footer-2 bg-cover bg-repeat pb-10 pt-16 lg:pt-28">
        <Container>
          <div className="flex flex-col items-center gap-10 md:gap-20">
            <div className="flex flex-row items-start gap-10 md:gap-20 self-start">
